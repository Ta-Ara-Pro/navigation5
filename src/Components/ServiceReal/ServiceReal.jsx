      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: "16px", color: "#444", lineHeight: "1.6", marginBottom: "1rem" }}>
            {t('services.description.line1')}<br />
            {t('services.description.line2')}<br />
      ...
      {item.split('\n').map((line, i) => (
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* Labels */}
            <span className={`label top ${currentStep === 0 ? 'active' : ''}`} onClick={() => stepTaker(0)}>{t('services.labels.growth')}</span>
            <span className={`label left ${currentStep === 1 ? 'active' : ''}`} onClick={() => stepTaker(1)}>{t('services.labels.trends')}</span>
            <span className={`label bottom ${currentStep === 2 ? 'active' : ''}`} onClick={() => stepTaker(2)}>{t('services.labels.consultancy')}</span>
            <span className={`label right ${currentStep === 3 ? 'active' : ''}`} onClick={() => stepTaker(3)}>{t('services.labels.brand').split('\n').map((line, i) => (
        <React.Fragment key={i}>
          {line}
          <br />
        </React.Fragment>
